...
permalink: /publication/2025-08-23-textonly-number-5
excerpt: 'We propose TextOnly, a unified text-based function portal that uses a single text box to trigger actions across apps. The system integrates an LLM with a continually adapting BERT model to interpret user intent from short inputs with improving accuracy and speed. User studies show strong usability, with 71.35% top-1 accuracy and clear preference over manual actions and voice assistants.'
date: 2025-08-23
rating: 5
